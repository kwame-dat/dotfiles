...
#+begin_src sh
  mu init --maildir=~/Maildir --my-address=tony@arksolutions.it --my-address=tampomah@emporium.co.uk --my-address=tony.ampomah.jw@gmail.com itechytony@gmail.com
#+end_src
** Bindings
#+begin_src emacs-lisp
