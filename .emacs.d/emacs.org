...
- [[#configuration][Configuration]]
  ...
  - [[#core][CORE]]
    ...
    - [[#keep-emacsd-clean-no-littering][Keep .emacs.d clean =no-littering=]]
    - [[#functions][functions]]
  ...
  - [[#app][APP]]
    ...
    - [[#slack][slack]]
    - [[#reading-books-with-calibre][Reading books with calibre]]
...
*** Keep .emacs.d clean =no-littering=
#+begin_src emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (my-leader-def 'normal 'override
      ...
      "npt" '(lambda() (interactive) (find-file "~/org/personal/PTodo.org"))
      "npn" '(lambda() (interactive) (find-file "~/org/personal/PNotes.org"))
      "nps" '(lambda() (interactive) (find-file "~/org/personal/PSomeday.org"))
      "nwt" '(lambda() (interactive) (find-file "~/org/work/WTodo.org"))
      "nwn" '(lambda() (interactive) (find-file "~/org/work/WNotes.org"))
      "nws" '(lambda() (interactive) (find-file "~/org/work/WSomeday.org"))
      "na" 'org-agenda
...
#+begin_src emacs-lisp
  (use-package base16-theme
    :ensure t
    :demand t
    :config (load-theme 'base16-tomorrow-night))
#+end_src
...
#+begin_src emacs-lisp
  ...
  ;;   '((t (:foreground "#CEBFF3" :background "#181818")))
...
#+begin_src emacs-lisp
  ...
  (setq org-agenda-files (quote (
                                 "~/org/personal/PTodo.org"
                                 "~/org/spiritual/STodo.org"
                                 "~/org/joint/JTodo.org"
                                 "~/org/work/WTodo.org"
                                 )))
#+end_src
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        '(
          ("i" "Inbox" entry (file "~/org/personal/Inbox.org")
           "* TODO %?\n %i\n")
          ("e" "Email" entry (file+headline "~/org/personal/Inbox.org" "Emails")
           "* TODO [#A] Process Email %:fromname on %:subject\nSCHEDULED:%t\nDEADLINE: %(org-insert-time-stamp (org-read-date nil t \"+2d\"))\n:PROPERTIES:\n:CREATED: %U\n:END:\n %a" :immediate-finish t :prepend t)
          ("p" "Project" entry (file+headline "~/org/personal/PTodo.org" "1Projects")
           (file "~/org/personal/templates/new-project.org"))
          ("w" "workProject" entry (file+headline "~/org/work/WTodo.org" "1Projects")
           (file "~/org/personal/templates/new-project.org"))
          ...
          ("s" "Someday" entry (file+headline "~/org/personal/PSomeday.org" "Someday")
           "* SOMEDAY %?\n")))
...
#+begin_src emacs-lisp
  (use-package org-contacts
    :ensure nil
    :after org
    :custom (org-contacts-files '("~/org/personal/contacts/contacts.org")))
#+end_src
...
#+BEGIN_SRC emacs-lisp
  (defun go-to-projects ()
    (interactive)
    (find-file "~/org/personal/PTodo.org")
    (widen)
    (beginning-of-buffer)
...
#+BEGIN_SRC emacs-lisp
  (defun my-new-daily-review ()
    ...
    (let ((org-capture-templates '(("d" "Review: Daily Review" entry (file+olp+datetree "/tmp/reviews.org")
                                    (file "~/org/personal/reviews/daily-review-template.org")))))
      (progn
        (org-capture nil "d")
  ...
  (defun my-new-weekly-review ()
    ...
    (let ((org-capture-templates '(("w" "Review: Weekly Review" entry (file+olp+datetree "/tmp/reviews.org")
                                    (file "~/org/personal/reviews/weekly-review-template.org")))))
      (progn
        (org-capture nil "w")
        (org-capture-finalize t)
        (org-speed-move-safe 'outline-up-heading)
  ...
  (defun my-new-monthly-review ()
    ...
    (let ((org-capture-templates '(("m" "Review: Monthly Review" entry (file+olp+datetree "/tmp/reviews.org")
                                    (file "~/org/personal/reviews/monthly-review-template.org")))))
      (progn
        (org-capture nil "m")
        (org-capture-finalize t)
        (org-speed-move-safe 'outline-up-heading)
...
#+begin_src emacs-lisp
  (use-package emms
    ...
    (setq emms-source-file-default-directory "~/Music/Tony"
  ...
  ;;   (setq emms-directory "~/Music/Tony")
  ;;   :bind
  ;;   ("s-m p" . emms)
   ...
   (use-package slack
     ...
     (slack-register-team
      ...
      :token (auth-source-pick-first-password
              ...
              :user "token")
      :subscribed-channels '(elico qa devops standup general ops-issues poker-planning php74upgrade)
...
#+begin_src emacs-lisp
  (use-package calibredb
    ...
    :config
    (setq calibredb-root-dir "~/Documents/Personal/3Resources/Calibre Library")
    (setq calibredb-db-dir (expand-file-name "metadata.db" calibredb-root-dir))
    (setq calibredb-library-alist '(("~/Documents/Personal/3Resources/Calibre Library"))))
#+end_src
