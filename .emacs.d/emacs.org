...
(setq itechytony/default-font-size 11)
...
(use-package general
  ...
  (my-leader-def 'normal 'override
    ...
    "nn" 'org-capture
    ;; notes spiritual
    "nst" '(lambda() (interactive) (find-file "~/Nextcloud/org/todo-spiritual.org"))
    "nsg" '(lambda() (interactive) (find-file "~/Nextcloud/org/goals-spiritual.org"))
    "nsc" '(lambda() (interactive) (find-file "~/Nextcloud/org/calendar/spiritual.org"))
    ;; notes personal
    "npt" '(lambda() (interactive) (find-file "~/Nextcloud/org/todo-personal.org"))
    "npc" '(lambda() (interactive) (find-file "~/Nextcloud/org/calendar/personal.org"))
    "npg" '(lambda() (interactive) (find-file "~/Nextcloud/org/goals-personal.org"))
    ;; notes home
    "nht" '(lambda() (interactive) (find-file "~/Nextcloud/org/todo-home.org"))
    "nhg" '(lambda() (interactive) (find-file "~/Nextcloud/org/goals-home.org"))
    "nhc" '(lambda() (interactive) (find-file "~/Nextcloud/org/calendar/home.org"))
    ;; notes work
    "nwt" '(lambda() (interactive) (find-file "~/Nextcloud/org/todo-work.org"))
    "nwc" '(lambda() (interactive) (find-file "~/Nextcloud/org/calendar/work.org"))
    "nwg" '(lambda() (interactive) (find-file "~/Nextcloud/org/goals-work.org"))
    "nv" 'org-search-view
    ":"  'eval-expression
    "cc"  'compile
...
(use-package projectile
  ...
  (setq projectile-project-search-path '(
                                         ...
                                         "~/Nextcloud/Documents/Home/1Projects"
                                         "~/Nextcloud/Documents/Home/2Areas"
                                         "~/Nextcloud/Documents/Home/3Resources"
...
(use-package org
  ...
  (setq org-agenda-files (quote (
                                 "~/Nextcloud/org/calendar/personal.org"
                                 "~/Nextcloud/org/calendar/shared.org"
                                 "~/Nextcloud/org/todo-home.org"
                                 "~/Nextcloud/org/todo-personal.org"
                                 "~/Nextcloud/org/todo-spiritual.org"
                                 "~/Nextcloud/org/todo-work.org"
                                 "~/Nextcloud/org/jira/DELREP.org"
                                 )))
  ...
  (setq org-capture-templates
        '(
          ("i" "Inbox" entry (file "~/Nextcloud/org/inbox.org")
           "* TODO %?\n")
          ("m" "Email" entry (file+headline "~/Nextcloud/org/inbox.org" "Emails")
           "* TODO [#A] Process mail from %:fromname on %:subject\nSCHEDULED:%t\nDEADLINE: %(org-insert-time-stamp (org-read-date nil t \"+2d\"))\n:PROPERTIES:\n:CREATED: %U\n:END:\n %a" :immediate-finish t :prepend t)
          ("p" "Project" entry (file+headline "~/Nextcloud/org/todo-personal.org" "1Projects")
           (file "~/Nextcloud/org/templates/new-project-template.org"))
          ("s" "Someday" entry (file+headline "~/Nextcloud/org/someday.org" "Someday")
           "* SOMEDAY %?\n")
          ("l" "Log" entry (file+olp+datetree "~/Nextcloud/org/log.org" "Log")
           (file "~/Nextcloud/org/templates/logtemplate.org"))))
...
(use-package org-jira
  ...
  :after org
  :config
  (setq org-jira-working-dir "~/Nextcloud/org/jira")
  :ensure t)
...
(setq user-full-name  "Tony Ampomah"
      mu4e-sent-folder "/arksolutions/Sent"
      mu4e-drafts-folder "/arksolutions/Drafts"
      mu4e-trash-folder "/arksolutions/Trash")
...
(defvar my-mu4e-account-alist
  '(("arksolutions"
    ...
    ("netsells"
     ...
     (mu4e-compose-signature-auto-include t)
     (mu4e-sent-folder "/netsells/[Gmail].Sent Mail")
     (mu4e-drafts-folder "/netsells/[Gmail].Drafts")
     (mu4e-trash-folder "/netsells/[Gmail].Bin")
     (user-mail-address "tony.ampomah@netsells.co.uk")
    ...
    ("jw-gmail"
     ...
     (mu4e-compose-signature . (concat
                                ...
                                "Tony\n"))
     (mu4e-compose-signature-auto-include t)
     (mu4e-sent-folder "/jw/[Gmail].Sent Mail")
     (mu4e-drafts-folder "/jw/[Gmail].Drafts")
     (mu4e-trash-folder "/jw/[Gmail].Trash")
    ...
    ("trainline"
     ...
     (mu4e-sent-folder "/thetrainline/Sent Items")
     (mu4e-drafts-folder "/thetrainline/Drafts")
     (mu4e-trash-folder "/thetrainline/Deleted Items")
     (user-mail-address "tony.ampomah@thetrainline.com")
     (smtpmail-default-smtp-server "smtp.outlook.com")
     (smtpmail-local-domain "outlook.com")
     (smtpmail-smtp-user "tony.ampomah@thetrainline.com")
...
(setq mu4e-refile-folder
      (lambda (msg)
        (cond
         ((string-match "^/arksolutions.*"
                        (mu4e-message-field msg :maildir))
          "/arksolutions/4Archives")
         ((string-match "^/netsells*"
                        (mu4e-message-field msg :maildir))
          "/netsells/4Archives")
         ((string-match "^/thetrainline*"
                        (mu4e-message-field msg :maildir))
          "/thetrainline/Archive")
         ((string-match "^/jw.*"
                        (mu4e-message-field msg :maildir))
          "/jw/4Archives")
...
;; for searches
(defvar d-spam "NOT (maildir:/arksolutions/Spam OR maildir:/netsells/[Gmail].Spam OR maildir:/jw/[Gmail].Spam OR maildir:/thetrainline/\"Junk E-Mail\" OR maildir:/thetrainline/\"Deleted Items\")")

; All archived folders
(defvar d-archive "NOT (maildir:/arksolutions/4Archives OR maildir:/jw/4Archives OR maildir:/netsells/[Gmail].4Archives OR maildir:/thetrainline/Archive)")

(defvar inbox-folders (string-join '("maildir:/arksolutions/INBOX"
                                     "maildir:/netsells/INBOX"
                                     "maildir:/jw/INBOX"
                                     "maildir:/thetrainline/INBOX")
                                   " OR "))

(defvar draft-folders (string-join '("maildir:/arksolutions/Drafts"
                                     "maildir:/netsells/[Gmail].Drafts"
                                     "maildir:/jw/[Gmail].Drafts"
                                     "maildir:/thetrainline/Drafts")
                                   " OR "))

(defvar spam-folders (string-join '("maildir:/arksolutions/Spam"
                                     "maildir:/netsells/[Gmail].Spam"
                                     "maildir:/jw/[Gmail].Spam"
                                     "maildir:/thetrainline/Junk Email")
                                  " OR "))
...
** Load secrets
#+BEGIN_SRC emacs-lisp
(load "~/Nextcloud/Documents/Personal/3Resources/Keys/secrets.el")
#+END_SRC
** Post Initialisation
