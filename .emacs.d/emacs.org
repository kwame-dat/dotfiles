...
(use-package eyebrowse
  ...
  :config (progn
            (define-key eyebrowse-mode-map (kbd "C-s-1") 'eyebrowse-switch-to-window-config-1)
            (define-key eyebrowse-mode-map (kbd "C-s-2") 'eyebrowse-switch-to-window-config-2)
            (define-key eyebrowse-mode-map (kbd "C-s-3") 'eyebrowse-switch-to-window-config-3)
            (define-key eyebrowse-mode-map (kbd "C-s-4") 'eyebrowse-switch-to-window-config-4)
            (define-key eyebrowse-mode-map (kbd "C-s-5") 'eyebrowse-switch-to-window-config-5)
            (define-key eyebrowse-mode-map (kbd "C-s-6") 'eyebrowse-switch-to-window-config-6)
            (define-key eyebrowse-mode-map (kbd "C-s-7") 'eyebrowse-switch-to-window-config-7)
            (define-key eyebrowse-mode-map (kbd "C-s-8") 'eyebrowse-switch-to-window-config-8)
            (define-key eyebrowse-mode-map (kbd "C-s-9") 'eyebrowse-switch-to-window-config-9)
            (define-key eyebrowse-mode-map (kbd "C-s-0") 'eyebrowse-switch-to-window-config-0)
            (eyebrowse-mode t)
...
(setq mu4e-get-mail-command "offlineimap_parallel.sh")
      ...
      `(
        ,(make-mu4e-context
          ...
          :vars '( ( user-mail-address      . "tony@arksolutions.it"  )
                   ...
                   ( mu4e-refile-folder . "/tony@arksolutions.it/4Archives")
        ...
        ,(make-mu4e-context
          ...
          :vars '( ( user-mail-address       . "tony.ampomah@netsells.co.uk" )
                   ( user-full-name          . "Tony Ampomah" )
                   ( smtpmail-smtp-server    . "smtp.gmail.com" )
                   ( mu4e-refile-folder . "/tony.ampomah@netsells.co.uk/4Archives")
                   ( mu4e-trash-folder . "/tony.ampomah@netsells.co.uk/[Gmail].Bin")
                   ( mu4e-sent-folder . "/tony.ampomah@netsells.co.uk/[Gmail].Sent Mail")
                   ( mu4e-drafts-folder . "/tony.ampomah@netsells.co.uk/[Gmail].Drafts")
                   ( mu4e-compose-signature  .
                                             (concat
                                              "Tony Ampomah\n"
...
** Load secrets
#+BEGIN_SRC emacs-lisp
(load "~/Sync/Documents/Personal/3Resources/Keys/secrets.el")
#+END_SRC
** Post Initialisation
