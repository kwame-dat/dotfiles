...
#+BEGIN_SRC emacs-lisp
  ...
  (setq tramp-histfile-override "/tmp/.tramp")
  (require 'tramp-cache)
...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (my-leader-def 'normal 'override
      ...
      "fp1"  '(lambda() (interactive) (find-file "~/Repo/Personal/1Projects"))
      "fp2"  '(lambda() (interactive) (find-file "~/Repo/Personal/2Areas"))
      "fp3"  '(lambda() (interactive) (find-file "~/Repo/Personal/3Resources"))
      "fp4"  '(lambda() (interactive) (find-file "~/Repo/Personal/4Archives"))
      "fp5"  '(lambda() (interactive) (find-file "~/Repo/Personal"))
      ...
      "fw5"  '(lambda() (interactive) (find-file "~/Repo/Work"))
      ...
      "dp1" '(lambda() (interactive) (find-file "~/Documents/personal/1Projects"))
      "dp2" '(lambda() (interactive) (find-file "~/Documents/personal/2Areas"))
      "dp3" '(lambda() (interactive) (find-file "~/Documents/personal/3Resources"))
      "dp4" '(lambda() (interactive) (find-file "~/Documents/personal/4Archives"))
      "dw1" '(lambda() (interactive) (find-file "~/Documents/Work/1Projects"))
      "dw2" '(lambda() (interactive) (find-file "~/Documents/Work/2Areas"))
      "dw3" '(lambda() (interactive) (find-file "~/Documents/Work/3Resources"))
      "dw4" '(lambda() (interactive) (find-file "~/Documents/Work/4Archives"))
      ...
      "ni" '(lambda() (interactive) (find-file "~/Sync/org/personal/Inbox.org"))
      "npt" '(lambda() (interactive) (find-file "~/Sync/org/personal/PTodo.org"))
      "npn" '(lambda() (interactive) (find-file "~/Sync/org/personal/PNotes.org"))
      "nps" '(lambda() (interactive) (find-file "~/Sync/org/personal/PSomeday.org"))
      "nwt" '(lambda() (interactive) (find-file "~/Sync/org/work/WTodo.org"))
      "nwn" '(lambda() (interactive) (find-file "~/Sync/org/work/WNotes.org"))
      "nws" '(lambda() (interactive) (find-file "~/Sync/org/work/WSomeday.org"))
      "na" 'org-agenda
...
#+begin_src emacs-lisp
  (use-package base16-theme
    :ensure t
    :demand t
    :config (load-theme 'base16-harmonic-dark))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (defface my-pl-segment1-active
    '((t (:foreground "#000000" :background "#568bbf")))
    "Powerline first segment active face.")
  (defface my-pl-segment1-inactive
    '((t (:foreground "#CEBFF3" :background "#3A2E58")))
    "Powerline first segment inactive face.")
  (defface my-pl-segment2-active
    '((t (:foreground "#d7d7d7" :background "#8f3d3d")))
    "Powerline second segment active face.")
  (defface my-pl-segment2-inactive
    '((t (:foreground "#CEBFF3" :background "#0b1c2c")))
...
#+begin_src emacs-lisp
  ...
  (setq org-agenda-files (quote (
                                 "~/Sync/org/personal/PTodo.org"
                                 "~/Sync/org/spiritual/STodo.org"
                                 "~/Sync/org/joint/JTodo.org"
                                 "~/Sync/org/work/WTodo.org"
                                 )))
#+end_src
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        '(
          ("i" "Inbox" entry (file "~/Sync/org/personal/Inbox.org")
           "* TODO %?\n %i\n")
          ("e" "Email" entry (file+headline "~/Sync/org/personal/Inbox.org" "Emails")
           "* TODO [#A] Process Email %:fromname on %:subject\nSCHEDULED:%t\nDEADLINE: %(org-insert-time-stamp (org-read-date nil t \"+2d\"))\n:PROPERTIES:\n:CREATED: %U\n:END:\n %a" :immediate-finish t :prepend t)
          ("p" "Project" entry (file+headline "~/Sync/org/personal/PTodo.org" "1Projects")
           (file "~/Sync/org/personal/templates/new-project.org"))
          ("w" "workProject" entry (file+headline "~/Sync/org/work/WTodo.org" "1Projects")
           (file "~/Sync/org/personal/templates/new-project.org"))
          ("m" "MeetingWorkbook" entry (file+headline "~/Sync/org/spiritual/SNotes.org" "Life & Ministry Workbook Comments")
           (file "~/Sync/org/spiritual/templates/workbook.org"))
          ("s" "Someday" entry (file+headline "~/Sync/org/personal/PSomeday.org" "Someday")
           "* SOMEDAY %?\n")))
...
#+begin_src emacs-lisp
  (use-package org-contacts
    :ensure nil
    :after org
    :custom (org-contacts-files '("~/Sync/org/personal/contacts/contacts.org")))
#+end_src
...
#+BEGIN_SRC emacs-lisp
  (defun go-to-projects ()
    (interactive)
    (find-file "~/Sync/org/personal/PTodo.org")
    (widen)
    (beginning-of-buffer)
...
#+BEGIN_SRC emacs-lisp
  (defun my-new-daily-review ()
    ...
    (let ((org-capture-templates '(("d" "Review: Daily Review" entry (file+olp+datetree "/tmp/reviews.org")
                                    (file "~/Sync/org/personal/reviews/daily-review-template.org")))))
      (progn
        (org-capture nil "d")
  ...
  (defun my-new-weekly-review ()
    ...
    (let ((org-capture-templates '(("w" "Review: Weekly Review" entry (file+olp+datetree "/tmp/reviews.org")
                                    (file "~/Sync/org/personal/reviews/weekly-review-template.org")))))
      (progn
        (org-capture nil "w")
        (org-capture-finalize t)
        (org-speed-move-safe 'outline-up-heading)
  ...
  (defun my-new-monthly-review ()
    ...
    (let ((org-capture-templates '(("m" "Review: Monthly Review" entry (file+olp+datetree "/tmp/reviews.org")
                                    (file "~/Sync/org/personal/reviews/monthly-review-template.org")))))
      (progn
        (org-capture nil "m")
        (org-capture-finalize t)
        (org-speed-move-safe 'outline-up-heading)
...
#+BEGIN_SRC emacs-lisp
  (defun my-nov-font-setup ()
    (face-remap-add-relative 'variable-pitch :family "Lexend Deca"
                             :height 1.2))
  (use-package nov)
