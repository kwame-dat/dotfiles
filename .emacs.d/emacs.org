...
*** Trainline
#+BEGIN_SRC emacs-lisp
(defun trainline/access-ftp-server ()
  (interactive)
  (find-file "/sftp:railguard_master@ftp.ttlprod.local:/"))

(defun trainline/access-c53 ()
  (interactive)
  (find-file "/ssh:c53:/"))

(defun trainline/access-c54 ()
  (interactive)
  (find-file "/ssh:c54:/"))

(defun trainline/access-c99 ()
  (interactive)
  (find-file "/ssh:c99:/"))

(defun trainline/access-st1 ()
  (interactive)
  (find-file "/ssh:st1:/"))
#+END_SRC
...
(add-hook 'text-mode 'fira-code-mode)
(add-hook 'org-mode 'fira-code-mode)
(add-hook 'markdown-mode 'fira-code-mode)
#+END_SRC
** Packages
...
(use-package general
  ...
  (my-leader-def 'normal 'override
    ...
    "fS"  'write-file
    ;; documents
    "dp" '(lambda() (interactive) (find-file "~/Nextcloud/Documents/1Projects"))
    "da" '(lambda() (interactive) (find-file "~/Nextcloud/Documents/2Areas"))
    "dr" '(lambda() (interactive) (find-file "~/Nextcloud/Documents/3Resources"))
    "dc" '(lambda() (interactive) (find-file "~/Nextcloud/Documents/4Archives"))
    ;; buffers
...
(use-package org
  ...
  (setq org-agenda-files (quote (
                                 ...
                                 "~/Nextcloud/org/tcal.org"
                                 "~/Nextcloud/org/ncal.org"
                                 "~/Nextcloud/org/pcal.org"
...
(use-package slack
  ...
  (slack-register-team
   ...
   :token (auth-source-pick-first-password
           :host "trainline.slack.com"
           :user "tony.ampomah@thetrainline.com")
   :subscribed-channels '(delay-repay-cms)
   :full-and-display-names t)
  (slack-register-team
   :name "Netsells"
   :token (auth-source-pick-first-password
           :host "netsells.slack.com"
           :user "tony.ampomah@netsells.co.uk")
   :subscribed-channels '(devz-notification team-backend trainline-railguard)
   :full-and-display-names t))
...
(use-package magit
  ...
  (use-package github-clone :demand t)
