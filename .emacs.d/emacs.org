...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (my-leader-def 'normal 'override
      ...
      "ni" '(lambda() (interactive) (find-file "~/org/PInbox.org"))
      "nt" '(lambda() (interactive) (find-file "~/org/PTodo.org"))
      "na" 'org-agenda
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        '(
          ("i" "Inbox" entry (file+headline "~/org/PTodo.org" "Inbox")
           "* TODO %?\n")
          ("e" "Email" entry (file+headline "~/org/PTodo.org" "Inbox")
...
** Load secrets
#+BEGIN_SRC emacs-lisp
  (when (file-exists-p "~/Documents/3Resources/Keys/secrets.el")
    (load "~/Documents/3Resources/Keys/secrets.el"))
#+END_SRC
