...
#+BEGIN_SRC emacs-lisp
  ...
  (defun itechytony/unraid ()
    (interactive)
    (find-file "/ssh:root@192.168.1.3:/"))

  (defun itechytony/sftp/unraid ()
    (interactive)
    (find-file "/sftp:root@192.168.1.3:/"))
...
**** emporium
#+begin_src emacs-lisp
  (defun emporium/ansible-1 ()
    (interactive)
    (find-file "/ssh:ansible-1:/"))
#+end_src
** KEYBINDINGS
*** core-keybindings
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (my-leader-def 'normal 'override
      ...
      "ni" '(lambda() (interactive) (find-file "~/Org/Personal/PInbox.org"))
      "nt" '(lambda() (interactive) (find-file "~/Org/Personal/PTodo.org"))
      "na" 'org-agenda
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        '(
          ("i" "Inbox" entry (file+headline "~/Org/Personal/PTodo.org" "Inbox")
           "* TODO %?\n")
          ("e" "Email" entry (file+headline "~/Org/Personal/PTodo.org" "Inbox")
          ...
          ("s" "Someday" entry (file+headline "~/Org/Personal/Someday.org" "Someday")
           "* SOMEDAY %?\n")))
