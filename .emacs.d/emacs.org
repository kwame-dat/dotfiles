    ...
    #+BEGIN_SRC emacs-lisp
      (use-package general
        ...
        (my-leader-def 'normal 'override
          ...
          ;; notes
          "nf" '(lambda() (interactive) (counsel-find-file "~/Dropbox/org"))
          "n." '(lambda() (interactive) (counsel-find-file "~/Dropbox/org"))
          "ni" '(lambda() (interactive) (find-file "~/Dropbox/org/inbox.org"))
          "na" 'org-agenda
          "nci" 'org-pomodoro
          "nco" 'org-pomodoro-clock-break
          "nn" 'org-capture
          ;; notes spiritual
          "nst" '(lambda() (interactive) (find-file "~/Dropbox/org/todo-spiritual.org"))
          "nsg" '(lambda() (interactive) (find-file "~/Dropbox/org/goals-spiritual.org"))
          "nsc" '(lambda() (interactive) (find-file "~/Dropbox/org/calendar/spiritual.org"))
          ;; notes personal
          "npt" '(lambda() (interactive) (find-file "~/Dropbox/org/todo-personal.org"))
          "npc" '(lambda() (interactive) (find-file "~/Dropbox/org/calendar/personal.org"))
          "npg" '(lambda() (interactive) (find-file "~/Dropbox/org/goals-personal.org"))
          ;; notes home
          "nht" '(lambda() (interactive) (find-file "~/Dropbox/org/todo-home.org"))
          "nhg" '(lambda() (interactive) (find-file "~/Dropbox/org/goals-home.org"))
          "nhc" '(lambda() (interactive) (find-file "~/Dropbox/org/calendar/home.org"))
          ;; notes work
          "nwt" '(lambda() (interactive) (find-file "~/Dropbox/org/todo-work.org"))
          "nwc" '(lambda() (interactive) (find-file "~/Dropbox/org/calendar/work.org"))
          "nwg" '(lambda() (interactive) (find-file "~/Dropbox/org/goals-work.org"))
          "nv" 'org-search-view
          ":"  'eval-expression
          "cc"  'compile
...
*** =org-mode=
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (setq org-agenda-files (quote (
                                     ...
                                     "~/Dropbox/org/todo-home.org"
                                     "~/Dropbox/org/todo-personal.org"
                                     "~/Dropbox/org/todo-spiritual.org"
                                     "~/Dropbox/org/todo-work.org"
                                     "~/Dropbox/org/jira/DELREP.org"
                                     )))
      ...
      (setq org-capture-templates
            '(
              ("i" "Inbox" entry (file "~/Dropbox/org/inbox.org")
               "* TODO %?\n")
              ("m" "Email" entry (file+headline "~/Dropbox/org/inbox.org" "Emails")
               "* TODO [#A] %?\nSCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"+0d\"))\n%a\n")
              ("p" "Project" entry (file+headline "~/Dropbox/org/todo-personal.org" "1Projects")
               (file "~/Dropbox/org/templates/new-project-template.org"))
              ("s" "Someday" entry (file+headline "~/Dropbox/org/someday.org" "Someday")
               "* SOMEDAY %?\n")
