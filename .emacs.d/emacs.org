    ...
    #+BEGIN_SRC emacs-lisp
      (use-package general
        ...
        (my-leader-def 'normal 'override
          ...
          "nn" 'org-capture
          ;; notes spiritual
          "nsi" '(lambda() (interactive) (find-file "~/org/inbox-spiritual.org"))
          ...
          ;; notes personal
          "npi" '(lambda() (interactive) (find-file "~/org/inbox-personal.org"))
          ...
          ;; notes home
          "nhi" '(lambda() (interactive) (find-file "~/org/inbox-home.org"))
          ...
          ;; notes work
          "nwi" '(lambda() (interactive) (find-file "~/org/inbox-work.org"))
...
*** =nov=
    #+BEGIN_SRC emacs-lisp
      (defun my-nov-font-setup ()
        (face-remap-add-relative 'variable-pitch :family "Quicksand"
                                 :height 1.3))
      (use-package nov)
...
*** =perspective=
    #+BEGIN_SRC emacs-lisp
      ...
      (setq persp-state-default-file "~/.emacs.d/workspace/default")
