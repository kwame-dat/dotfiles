...
(setq itechytony/default-font-size 14)
...
(define-key global-map (kbd "s-0") 'itechytony/reset-font-size)
(define-key global-map (kbd "s-+") 'itechytony/increase-font-size)
(define-key global-map (kbd "s-=") 'itechytony/increase-font-size)
(define-key global-map (kbd "s-_") 'itechytony/decrease-font-size)
(define-key global-map (kbd "s--") 'itechytony/decrease-font-size)
