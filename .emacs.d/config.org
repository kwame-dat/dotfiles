...
** Set default font and configure font resizing
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq kwamedat--default-font-size 14)
     ...
     (defun kwamedat--set-font-size ()
       "Set the font to `kwamedat--default-font' at `kwamedat--current-font-size'.
     ...
     (defun kwamedat--increase-font-size ()
       "Increase current font size by a factor of `kwamedat--font-change-increment'."
       (interactive)
     ...
     (defun kwamedat--decrease-font-size ()
       "Decrease current font size by a factor of `kwamedat--font-change-increment', down to a minimum size of 1."
       (interactive)
       (setq kwamedat--current-font-size
             (max 1
