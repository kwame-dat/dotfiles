...
* Publishing and Task Management =org-mode=
  #+BEGIN_SRC emacs-lisp
    ...
    (setq org-agenda-files (quote ("~/Dropbox/GTD/todo.org"
                                   "~/Dropbox/GTD/inbox.org"
                                   "~/Dropbox/GTD/inbox.org"
                                   "~/Dropbox/GTD/goals.org")))

    (setq org-capture-templates
          '(("t" "Task" entry (file "~/Dropbox/GTD/inbox.org")
             "* TODO %?\n")
            ("p" "Project" entry (file+headline "~/Dropbox/GTD/todo.org" "Projects")
             (file "~/Dropbox/GTD/templates/newprojecttemplate.org"))
            ("g" "Goals" entry (file+headline "~/Dropbox/GTD/goals.org" "Goals")
             "* SOMEDAY %?\n")
            ("l" "Log" entry (file+olp+datetree "~/Dropbox/GTD/log.org" "Log")
             (file "~/Dropbox/GTD/templates/logtemplate.org"))))
...
* VIM =evil-mode=
  #+BEGIN_SRC emacs-lisp
    ...
    (setq evil-want-C-u-scroll t)
    (setq evil-vsplit-window-right t) ;split to right always
    (setq evil-split-window-below t) ; split below always
    ...
    (defun kwamedat/apply-evil-other-package-configs ()
      ...
      (evil-define-key 'normal pdf-annot-minor-mode-map (kbd "s-0") 'pdf-view-scale-reset)
      (evil-define-key 'normal pdf-annot-minor-mode-map (kbd "s--") 'pdf-view-shrink)
      (evil-define-key 'normal pdf-annot-minor-mode-map (kbd "s-+") 'pdf-view-enlarge)
