...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'php-mode-hook
            '(lambda ()
               ...
               (define-key php-mode-map  ("C-]") 'ac-php-find-symbol-at-point)   ;goto define
...
Install =js2-mode= from editing Javascript code.
#+BEGIN_SRC emacs-lisp
...
** =gtags=
	 #+BEGIN_SRC emacs-lisp
		 ...
		 (use-package gtags)
	 #+END_SRC
** =bpr= for managing background process
   #+BEGIN_SRC emacs-lisp
   (use-package bpr)
   #+END_SRC
...
* Email with =mu4e=
  #+BEGIN_SRC emacs-lisp
    ...
    ;;            :vars '(
    ;;                    (mu4e-trash-folder . "/tony@arksolutions.it/[tony@arksolutions.it].Trash")
    ;;                    (mu4e-refile-folder . "/tony@arksolutions.it/[tony@arksolutions.it].Archive")
    ;;                    ))
    ;;          ))
  #+END_SRC
