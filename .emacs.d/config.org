...
* Managing Projects =projectile=
  #+BEGIN_SRC emacs-lisp
    (setq projectile-project-search-path '("~/Repositories/2 Areas"
                                           "~/Repositories/1 Projects"))
...
** Font
   #+BEGIN_SRC emacs-lisp
     ...
     (set-frame-font "Operator Mono 20" nil t)
    ...
    (setq smtpmail-debug-verbose t)
     ...
     `( ,(make-mu4e-context
         ...
         :vars '(
           ...
           (mu4e-refile-folder . "/netsells.co.uk/[Gmail].4 Archives")
           ))
       ,(make-mu4e-context
         :name "Arksolutions"
         :match-func (lambda (msg) (when msg
         ...
         :vars '(
           ...
           (mu4e-refile-folder . "/arksolutions.it/4 Archives")
           ))
       ))
