...
** Always indent with spaces
   ...
   #+END_SRC
* Helpers
** =kwamedat/edit-emacs-config-file=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/edit-emacs-config-file ()
        (interactive)
        (find-file "~/.emacs.d/config.org"))
    #+END_SRC
** =kwamedat/convert-markdown-to-org-file=
   #+BEGIN_SRC emacs-lisp
...
** =evil-collection=
   ...
   #+END_SRC
** =evil-leader=
*** =leader-projectile-keybindings=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/leader-projectile-keybindings ()
        (evil-leader/set-key
    ...
    #+END_SRC
*** =leader-buffer-keybindings=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/leader-buffer-keybindings()
        (evil-leader/set-key
    ...
    #+END_SRC
*** =leader-files-keybindings=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/leader-files-keybindings()
        (evil-leader/set-key
          "fCd" 'unix2dos
          "fCu" 'dos2unix
          ...
          "fee" 'kwamedat/edit-emacs-config-file
          "fei" 'find-user-init-file
          "fev" 'display-and-copy-version
          "fg" 'rgrep
    ...
    #+END_SRC
*** =leader-shell-keybindings=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/leader-shell-keybindings()
        (evil-leader/set-key
          "'" 'eshell
          "asT" 'term
          "ase" 'eshell
    ...
    #+END_SRC
*** =leader-help-keybindings=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/leader-help-keybindings()
        (evil-leader/set-key
          "hdb" 'describe-bindings
          "hdc" 'describe-char
          "hdf" 'describe-function
          "hdk" 'describe-key
          "hdl" 'kwamedat/describe-last-keys
          "hdp" 'describe-package
          "hdP" 'configuration-layer/describe-package
          "hds" 'kwamedat/describe-system-info
          "hdt" 'describe-theme
          "hdv" 'describe-variable
          "hI"  'kwamedat/report-issue
          "hn"  'view-emacs-news
          )
        )
    #+END_SRC
*** =leader-insert-keybindings=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/leader-insert-keybindings()
        (evil-leader/set-key
          "iJ" 'kwamedat/insert-line-below-no-indent
          "iK" 'kwamedat/insert-line-above-no-indent
          "ik" 'kwamedat/evil-insert-line-above
          "ij" 'kwamedat/evil-insert-line-below
          )
        )
    #+END_SRC
*** =leader-jump-keybindings=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/leader-jump-keybindings()
        (evil-leader/set-key
          "j0" 'kwamedat/push-mark-and-goto-beginning-of-line
          "j$" 'kwamedat/push-mark-and-goto-end-of-line
          "jf" 'find-function
          "jv" 'find-variable
          )
        )
    #+END_SRC
*** =leader-compilation-keybindings=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/leader-compilation-keybindings()
        (evil-leader/set-key
          "cC" 'compile
          "ck" 'kill-compilation
          "cr" 'recompile
    ...
    #+END_SRC
*** =leader-narrow-keybindings=
    #+BEGIN_SRC emacs-lisp
      (defun kwamedat/leader-narrow-keybindings()
        (evil-leader/set-key
          "nr" 'narrow-to-region
          "np" 'narrow-to-page
          "nf" 'narrow-to-defun
...
*** installation and configuration
    #+BEGIN_SRC emacs-lisp
      ...
      (use-package evil-leader
        ...
        (kwamedat/leader-projectile-keybindings)
        (kwamedat/leader-buffer-keybindings)
        (kwamedat/leader-files-keybindings)
        (kwamedat/leader-shell-keybindings)
        (kwamedat/leader-help-keybindings)
        (kwamedat/leader-insert-keybindings)
        (kwamedat/leader-jump-keybindings)
        (kwamedat/leader-compilation-keybindings)
        (kwamedat/leader-narrow-keybindings))
    #+END_SRC
...
** Set default font and configure font resizing
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq kwamedat/default-font-size 16)
